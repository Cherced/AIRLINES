  ...
  return (
    ...
    <React.Fragment>
      ...
      <div className={modal ? ("idioms--menu onn") : ( "idioms--menu offf" )} aria-label="menu container" >
        <button tabIndex="0" className="arrowButton--Modal"  onClick={()=> setModal(!modal)}>
          en
          <img className="arrowImg--Modal"  src="images/arrow-down.png" alt="arrow"/>
        </button>      
        <button className="menu-Btn" onClick={()=> setMenu(true)}>
          <Image width={30} height={30} layout="fill" className="menu-image" src="images/Navbar.png" alt="menu"/>
        </button>
      </div>
        <Banner/>
        <Offers/>
