...
export const TripsOffer = () => {
    const [gateInfo, setGateInfo] = React.useState(true) // estado para hacer el toggle
    const [gateInfoOne, setGateInfoOne] = React.useState(true) // estado para hacer el toggle
    const [gateInfoTwo, setGateInfoTwo] = React.useState(true) // estado para hacer el toggle
