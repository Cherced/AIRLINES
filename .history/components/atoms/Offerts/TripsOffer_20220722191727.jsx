...
export const TripsOffer = () => {
  ...
  return (
      <section className="cards">
        ...
        <div  className="cards__nav moscow">
        <ul className="cards__nav--list">
            ...
            <li className="cards__nav--price">
                    <a className="cards__item--price">
                        Price $600,86
                    </a>
            </li>             
        </ul>
        ...
        <div  className="cards__nav puertoRico">
            <img src="/images/puerto-rico.jpg" alt="Puerto Rico"/>
        <ul className="cards__nav--list">
        ...
        <div  className="cards__nav honduras">        
        <ul className="cards__nav--list">
