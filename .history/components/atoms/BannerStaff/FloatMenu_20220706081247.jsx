    ...
    <menu className={ menu? ("floatMenu--Container on"):("floatMenu--Container off")}>
        ...
        <button className="floatMenu--btn" onClick={() => setMenu(false)}>
            ...
            <ul className="floatMenu__list">
                <li className="floatMenu__list--item"><a>Home</a></li>
                <li className="floatMenu__list--item"><a>About</a></li>
                <li className="floatMenu__list--item"><a>Destinations</a></li>
                <li className="floatMenu__list--item"><a>Contact</a></li>
            </ul>
        </nav>
    </menu>
  )
